package valenzuela.manuel.calculadoraimc
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var txtAltura: EditText = findViewById(R.id.etAltura)
        ...
        btnCalcular.setOnClickListener{
            ...
            val imcNum = calcularIMC(txtAltura.text.toString().toDouble(), txtPeso.text.toString().toDouble())
